...
from config.settings import GPU_TARGET_MULTIPLIER
...
def render(db: Session):
    ...
    with tabs[0]:
        ...
        if not cpus:
            ...
            target_gpu_score = selected_cpu.get_score() * GPU_TARGET_MULTIPLIER
    ...
    with tabs[1]:
        ...
        if not gpus:
            ...
            target_cpu_score = selected_gpu.get_score() / GPU_TARGET_MULTIPLIER
